...
print("Swin Transformer device:", next(swin.parameters()).device)
...
swin = train_model(swin, train_loader, val_loader, criterion, optimizer, num_epochs=10)
...
evaluate_model(swin, test_loader, criterion)

torch.save(swin.to('cpu').state_dict(), "swin_t_v1.0_CIFAKE.pth")
print("\nSwin Transformer model saved as swin_t_v1.0_CIFAKE.pth")
